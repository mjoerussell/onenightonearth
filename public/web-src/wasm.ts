...
export class WasmInterface {
    ...
    projectStars(stars: Star[], location: Coord, timestamp: number): CanvasPoint[] {
        ...
        const result_ptr: pointer = (this.instance.exports.projectStarsWasm as any)(
            star_ptr,
            stars.length,
            location_ptr,
            BigInt(timestamp),
        ...
        const result: CanvasPoint[] = this.readArray(result_ptr, result_count, sizedCanvasPoint);
